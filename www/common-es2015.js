...
let CompanyService = class CompanyService {
    constructor(httpClient, nativeHTTP) {
        ...
        this.httpOpions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Authorization': 'Bearer ' + src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].token })
        };
    }
    getCompanyByUserPassword(username, userpassword) {
        let postData = {
        ...
        return this.httpClient.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiCompanies + 'login/', postData, this.httpOpions)
    ...
    getCompanyById(id, token) {
        ...
        return this.httpClient.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiCompanies + id, this.httpOpions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(2), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    ...
    addCompany(company) {
        ...
        return this.httpClient.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiCompanies, company)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(2), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
