  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    function srcAppServicesCompanyServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var CompanyService = /*#__PURE__*/function () {
        function CompanyService(httpClient, nativeHTTP) {
          ...
          this.httpOpions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
              'Authorization': 'Bearer ' + src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].token
            })
          };
        }

        _createClass(CompanyService, [{
          key: "getCompanyByUserPassword",
          value: function getCompanyByUserPassword(username, userpassword) {
            var postData = {
              "companyLogin": username,
            ...
            return this.httpClient.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiCompanies + 'login/', postData, this.httpOpions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(2), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
          }
        }, {
          key: "getCompanyById",
          value: function getCompanyById(id, token) {
            this.httpOpions = {
              headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'Authorization': 'Bearer ' + token
              })
            };
            return this.httpClient.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiCompanies + id, this.httpOpions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(2), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
          }
          /*async showConfirm(titulo:string){
            const alert = await this.atrCtrl.create({
              header: titulo,
              subHeader:'(Pre)signin confirmation',
              message:'Congratulations, your pre-registration was successful. Evaluate our application, and complete your registration to have access to all features.',
              buttons: ['OK']
            });
            alert.present();
          }*/
          ...
          value: function addCompany(company) {
            ...
            return this.httpClient.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiCompanies, company).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(2), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
