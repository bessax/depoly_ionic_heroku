...
/* harmony default export */ __webpack_exports__["default"] = ("<ion-icon (click)=\"toggleLikeState()\" tappable [@heart]=\"likeState\" size=\"large\" name=\"heart\"></ion-icon>\n");
...
AnimatedLikeComponent.ctorParameters = () => [];
AnimatedLikeComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-animated-like',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./animated-like.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/animated-like/animated-like.component.html")).default,
        animations: [
        ...
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./animated-like.component.scss */ "./src/app/components/animated-like/animated-like.component.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EstimatemodalComponent", function() { return EstimatemodalComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _ionic_native_file_chooser_ngx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic-native/file-chooser/ngx */ "./node_modules/@ionic-native/file-chooser/__ivy_ngcc__/ngx/index.js");
...
/* harmony import */ var _services_estimates_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../services/estimates.service */ "./src/app/services/estimates.service.ts");
...
let EstimatemodalComponent = class EstimatemodalComponent {
    constructor(fileChooser, formBuilder, navparams, localstorage, estimateservice) {
    ...
    submitForm() {
        ...
        this.estimateservice.addEstimated(this.objEstimate, this.userToken).subscribe((ret) => {
            console.log(ret);
        });
...
EstimatemodalComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-estimatemodal',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./estimatemodal.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/estimatemodal/estimatemodal.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./estimatemodal.component.scss */ "./src/app/estimatemodal/estimatemodal.component.scss")).default]
    })
...
/* harmony import */ var _feeds_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./feeds.page */ "./src/app/feeds/feeds.page.ts");
...
/* harmony import */ var _feeds_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./feeds-routing.module */ "./src/app/feeds/feeds-routing.module.ts");
/* harmony import */ var _feeds_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./feeds.page */ "./src/app/feeds/feeds.page.ts");
/* harmony import */ var _components_animated_like_animated_like_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/animated-like/animated-like.component */ "./src/app/components/animated-like/animated-like.component.ts");
/* harmony import */ var _estimatemodal_estimatemodal_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../estimatemodal/estimatemodal.component */ "./src/app/estimatemodal/estimatemodal.component.ts");
...
FeedsPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _feeds_routing_module__WEBPACK_IMPORTED_MODULE_4__["FeedsPageRoutingModule"]
        ],
...
/* harmony import */ var _services_postfeed_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/postfeed.service */ "./src/app/services/postfeed.service.ts");
...
/* harmony import */ var _popovercomponent_popovercomponent_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../popovercomponent/popovercomponent.page */ "./src/app/popovercomponent/popovercomponent.page.ts");
/* harmony import */ var _estimatemodal_estimatemodal_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../estimatemodal/estimatemodal.component */ "./src/app/estimatemodal/estimatemodal.component.ts");
...
let FeedsPage = class FeedsPage {
    constructor(atrCtrl, postfeedservice, localstorageservice, storage, popovercontroler, modalCtrl) {
    ...
    getLimitedPosts(initial, maximum, token) {
        console.log("token passado " + token);
        return this.postfeedservice.getPagPost(initial, maximum, token)
            .subscribe((pfeed) => {
            this.apostfeed = pfeed;
            //console.log('esse é o pfeed');      
        });
    }
    preparePhoto() {
        this.apostfeed.forEach((value) => {
    ...
    ShowPopover(prodDescript, prodValue) {
    ...
    ngAfterViewInit() {
        ...
        setTimeout(() => {
            this.getLimitedPosts(1, 20, this.token);
            //this.preparePhoto();
            // this.getAllCities();
        }, 1000);
    }
    openEstimateModal(idPostCompany) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
...
FeedsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-feeds',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./feeds.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/feeds/feeds.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./feeds.page.scss */ "./src/app/feeds/feeds.page.scss")).default]
    })
], FeedsPage);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EstimatesService", function() { return EstimatesService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
let EstimatesService = class EstimatesService {
    ...
    addEstimated(estimated, token) {
        ...
        return this.httpClient.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiEstimates, estimated, this.httpOpions)
...
EstimatesService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
EstimatesService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
//# sourceMappingURL=feeds-feeds-module-es2015.js.map